...
# ha = re.findall(r'[a-z][A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z][a-z]', quote)
# # print(ha)
# sa =''
# for i in ha:
#     sa+=i[4]
...
#     for i in range (500):
#         fad = dasa
#         ads = urllib3.request('get', f'http://www.pythonchallenge.com/pc/def/linkedlist.php?nothing={dasa}')
#         dasa = str(ads.data).split(' ')[-1].strip("'")
#         if dasa is None:break
#         print(fad, dasa, sep="\t", file=f)


## 5
# url =pickle.load(urlopen('http://www.pythonchallenge.com/pc/def/banner.p'))
# print(url)
# d=''
# for i in url:
