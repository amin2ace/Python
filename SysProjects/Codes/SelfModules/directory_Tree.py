...
This module represent a class 'Tree'
witch generates directory tree of all
subfolders for specific path.
    ...
    def __tree_ish(self, __dir: str):
        for _, directories, files in os.walk(__dir):
            ...
            for directory_ in directories:
                ...
                self.__tree_ish(os.path.join(__dir, directory_))
